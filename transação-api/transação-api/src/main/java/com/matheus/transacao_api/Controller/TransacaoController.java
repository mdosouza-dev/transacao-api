...
public class TransacaoController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Transação deletas com sucesso"),
            @ApiResponse(responseCode = "400", description = "Erro de requisição"),
            @ApiResponse(responseCode = "500", description = "Erro interno")
    })
    public ResponseEntity<Void> deletarTransacoes(@RequestBody TransacaoRequestDTO dto){
